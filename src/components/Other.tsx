        ...
        <>
            <div className='app'>
                ...
                <div className='box2'>
                    <ul>
                        <li>
                            <input type="range" id="volume" name="volume" min={0} max={100} value={rangeValueX}
                                   onChange={e => {
                        ...
                        <li>
                            <input type="range" id='volume' name='volume' min={0} max={100} value={rangeValueY}
                                   onChange={e => {
                        ...
                        <li>
                            <input type="range" id='volume' name='volume' min={0} max={360} value={rangeValueRotate}
                                   onChange={e => {
